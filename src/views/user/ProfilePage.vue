  ...
  <section>
    ...
    <div class="container">
     ...
     <div class="flex gap-5 flex-col md:flex-row">
      ...
      <div class="w-auto sm:w-80 flex-none rounded-xl">
        <div class="flex items-center space-x-2">
          <ul class="menu w-full bg-base-100 p-2 rounded-box glass  shadow-lg">
            <li>
              <a>
        ...
        <div class="card-body">
          ...
          <div class="mt-5 md:mt-0 md:col-span-2 w-full">
            <form @submit.prevent="updateProfile">
              ...
              <input type="text" id="email" class="input input-bordered block w-full" disabled :value="user.email" />

              <label for="jobtitle" class="label">Job Title</label>
              <input type="text" id="jobtitle" class="input input-bordered block w-full" v-model="job_title" />
